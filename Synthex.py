...
TEXT_COLOR = "#FF0000"
ACCENT_COLOR = "#00FF00"
# Se utiliza una fuente compatible con todos los glifos de Synthex para evitar errores de visualización.
FONT = ("Arial Unicode MS", 12)
BUTTON_FONT = ("Arial Unicode MS", 14, "bold") # Fuente un poco más grande para los botones
...
class SynthexTerminal(tk.Tk):
    ...
    def visualize_synthex_network(self, glyphs):
        ...
        if is_chaotic:
            # Layout caótico: Dibujar glifos en posiciones aleatorias
            for i, glyph in enumerate(glyphs):
                ...
                self.canvas.create_text(x, y, text=glyph, fill=ACCENT_COLOR, font=(FONT[0], 18, "bold"), tags=f"glyph_{i}")
